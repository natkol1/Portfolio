...
|---|---|---|---|
| 1 | Исследование рынка кинопроката  | Выявление трендов кинорынка, / изучение наиболее востребованных у зрителей категории фильмов, / изучение фильмов, получивщих гос. поддержку.  | Python, Pandas, предобработка данных, исследовательский анализ данных, визуализация данных  |   
